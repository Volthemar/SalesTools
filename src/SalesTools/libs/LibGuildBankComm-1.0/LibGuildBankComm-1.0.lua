...
-- @release $Id: LibGuildBankComm-1.0.lua 85 2018-04-16 03:47:37Z myrroddin $

--[[
Name: LibGuildBankComm-1.0
Revision: $Revision: 85 $
Date: $Date: 2018-04-16 03:47:37 +0000 (Mon, 16 Apr 2018) $
...
local MINOR_VERSION = tonumber(("$Revision: 85 $"):match("%d+")) or 90000
